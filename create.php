...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="insert into peserta (NIM,nama,kelas,no_hp,alamat) values
		('$NIM','$nama','$kelas','$no_hp','$alamat')";
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        ...
        <div class="form-group">
            <label>nama:</label>
            <input type="text" name="nama" class="form-control" placeholder="Masukan NIM nama" required/>
        </div>
       <div class="form-group">
            <label>kelas :</label>
